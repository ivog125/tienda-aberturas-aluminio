...
function renderNav(activePage) {
  const ventanasActive = activePage === 'ventanas.html';

  const links = `
    <li><a href="index.html" class="${activePage === 'index.html' ? 'active' : ''}">Inicio</a></li>
    <li class="nav-dropdown" id="nav-ventanas-drop">
      <a href="ventanas.html" class="${activePage === 'ventanas.html' ? 'active' : ''}" onclick="toggleNavDropdown(event,'nav-ventanas-drop')">
        Ventanas <span class="nav-drop-caret">▾</span>
      </a>
      <ul class="nav-drop-menu">
        <li><a href="ventanas.html#herrero">Línea Herrero</a></li>
        <li><a href="ventanas.html#aluminio">Aluminio</a></li>
        <li><a href="ventanas.html#a30">A30</a></li>
      </ul>
    </li>
    <li class="nav-dropdown" id="nav-puertas-drop">
      <a href="puertas.html" class="${activePage === 'puertas.html' ? 'active' : ''}" onclick="toggleNavDropdown(event,'nav-puertas-drop')">
        Puertas y Portones <span class="nav-drop-caret">▾</span>
      </a>
      <ul class="nav-drop-menu">
        <li><a href="puertas.html#chapa">Chapa</a></li>
        <li><a href="puertas.html#aluminio">Aluminio</a></li>
      </ul>
    </li>
    <li><a href="complementos.html" class="${activePage === 'complementos.html' ? 'active' : ''}">Complementos</a></li>
    <li><a href="revestimientos.html" class="${activePage === 'revestimientos.html' ? 'active' : ''}">Revestimientos</a></li>
    <li><a href="obras.html" class="${activePage === 'obras.html' ? 'active' : ''}">Obras</a></li>
    <li><a href="contacto.html" class="${activePage === 'contacto.html' ? 'active' : ''}">Contacto</a></li>
  `;
  ...
  <div class="cart-sidebar" id="cart-sidebar">
    ...
    <div class="cart-footer" id="cart-footer" style="display:none;">
      ...
      <div class="cart-actions">
        ...
        <button class="btn-transferencia" onclick="pagarTransferencia()">
...
function toggleNavDropdown(e, dropId) {
  e.preventDefault();
  document.querySelectorAll('.nav-dropdown.open').forEach(d => { if (d.id !== dropId) d.classList.remove('open'); });
